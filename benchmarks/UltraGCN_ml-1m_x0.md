...
A notebook to benchmark UltraGCN on Movielens-1M dataset.
...
### Dataset
We follow the data split and preprocessing steps in LFCN. We directly transform the formats of the data from their [repo](https://github.com/Wenhui-Yu/LCFN).
...
### Results
Recall@20: 0.278671208895094

NDCG@20 = 0.26421063460327485
